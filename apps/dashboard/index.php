        ...
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-danger">
            ...
            <h3><?php echo $count_repair_today;?></h3>
              ...
              <p><?php lang("Send Mail");?></p>
            </div>
            <div class="icon">
            <i class="fas fa-paper-plane"></i>
            </div>
            <a href="?page=sendmail" class="small-box-footer"><?php lang("View More");?> <i class="fas fa-arrow-circle-right"></i></a>
          </div>
                          ...
                          <div class="modal-content">
                            ...
                            <div class="container-fluid">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-8"><p><?php echo $repair["inventory_id"];?></p></div>
                              </div>
                              <div class="row">
