            ...
            <div class="card-body">
              <form id="forminfo" class="form-horizontal" enctype="multipart/form-data" action="apps/repair/do_repair.php?action=create_repair"
                ...
                <div class="form-group row">
                  <label for="problem" class="col-sm-2 col-form-label"><?php lang("Inventory");?> <span class="text-danger">*</span></label>
                  <div class="col-sm-10">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                  <input name="problem" id="problem" type="text" class="form-control">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  <label for="email" class="col-sm-2 col-form-label"><?php lang("Email");?> <span
                      class="text-danger"><small>ใช้รับการแจ้งเตือน</small></span></label>
                  <div class="col-sm-10">
                    <input type="email" required name="email" id="email"rows="5" class="form-control"></input>
                  </div>
                </div>
