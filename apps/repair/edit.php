              ...
              <div class="tab-content">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                      ...
                      <input name="inven" id="inven" type="text" class="form-control" <?php echo $disabled;?> value="<?php echo $repair["inventory_id"];?>">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                  <input name="problem" id="problem" type="text" class="form-control" <?php echo $disabled;?> value="<?php echo $repair["problem"];?>">
                  </div>
                </div>
