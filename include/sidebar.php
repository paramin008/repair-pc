...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  &nbsp <i class="fas fa-wrench"></i>
    <span class="brand-text font-weight-light">&nbsp<?php lang("Repairing System Online");?></span>
  </a>
  ...
  <div class="sidebar os-host os-theme-light os-host-overflow os-host-overflow-y os-host-resize-disabled os-host-scrollbar-horizontal-hidden os-host-transition">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column nav-compact nav-child-indent text-sm" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <?php if($_SESSION["POSITION"] == "1"){?>
        <li class="nav-item">
          <a href="?page=sendmail" class="nav-link <?php if(in_array($page, $arr_sendmail)){echo "active"; }?>">
          &nbsp <i class="fas fa-paper-plane"></i>
            <p>
            &nbsp&nbsp <?php lang("Send Mail");?>
            </p>
          </a>
        </li> <?php } ?>
        <li class="nav-item">
